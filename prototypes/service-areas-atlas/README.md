...
This directory contains an intentionally isolated, framework-free prototype for a future Perma Painting service-area section. It does not change or load from any published page.
